...
@Composable
fun HabitsView(
    morningHabits: List<Habit>,
    noonHabits: List<Habit>,
    eveningHabits: List<Habit>,
    allDayHabits: List<Habit>,
) {
    ...
    Column(
        ...
        TimeOfDayItems(timeOfDay = TimeOfDay.Morning, habits = morningHabits)
        TimeOfDayItems(timeOfDay = TimeOfDay.Noon, habits = noonHabits)
        TimeOfDayItems(timeOfDay = TimeOfDay.Evening, habits = eveningHabits)
        TimeOfDayItems(timeOfDay = TimeOfDay.AllDay, habits = allDayHabits)
    }

}

@Composable
fun TimeOfDayItems(modifier: Modifier = Modifier, timeOfDay: TimeOfDay, habits: List<Habit>) {
    Column(
        modifier = modifier
            .padding(top = 8.dp)
            .fillMaxWidth()
